...
UI_IMG = "https://te.legra.ph/file/73209b40b167750d9c637.jpg"
...
PM_START_TEXT = """
────「 [˹ iƈσɳι𝚌 ✘ ᴍᴜsɪᴄ ˼](https://te.legra.ph/file/bb69ee128b9c4b7e8f02c.mp4) 」────
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgUAAxkBAAIV3mTHhDyEdKZjq41FphBTXrsAAV_IuAAC3wYAAheWCFTqeg1k0vwVuy8E"
                )
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs 🍷", url=f"https://t.me/iconic_botshub"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                f"@{SUPPORT_CHAT}",
                photo=f"https://te.legra.ph/file/358a5e444083bd8649549.jpg",
                caption=f"""
✨ㅤ{BOT_NAME} ɪs ᴀʟɪᴠᴇ ʙᴀʙʏ.
━━━━━━━━━━━━━
**ᴍᴀᴅᴇ ᴡɪᴛʜ ❤️ ʙʏ ⏤͟͞𝘼𝘽𝙃𝙄🥀**
**ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ:** `{y()}`
